...
covers the entire Openmandriva Lx GNU/Linux distribution. If you agree with all the
terms it contains, check the \"%s\" box. If not, clicking on the \"%s\"
button will reboot your computer.", N("Accept"), N("Quit"));
}
sub setRootPassword_addUser() {
    N("OpenMandriva Lx is a multi-user system which means each user can have his or her
...
sub chooseCd() {
    N("The Openmandriva Lx GNU/Linux installation is distributed on several CD-ROMs. If a
...
There are thousands of packages available for Openmandriva Lx GNU/Linux, and to make it
simpler to manage, they have been placed into groups of similar
applications.

Openmandriva Lx GNU/Linux sorts package groups in four categories. You can mix and
...
installed. By default Openmandriva Lx GNU/Linux will automatically start any installed
services at boot time. Even if they are safe and have no known issues at
the time the distribution was shipped, it is entirely possible that
security holes were discovered after this version of Openmandriva Lx GNU/Linux was
...
WindowMaker, etc.) bundled with Openmandriva Lx GNU/Linux rely upon.
...
sub doPartitionDisks() {
    N("You now need to decide where you want to install the Openmandriva Lx GNU/Linux
operating system on your hard drive. If your hard drive is empty or if an
existing operating system is using all the available space you will have to
partition the drive. Basically, partitioning a hard drive means to
logically divide it to create the space needed to install your new
Openmandriva Lx GNU/Linux system.
...
recommended if you want to use both Openmandriva Lx GNU/Linux and Microsoft Windows on
the same computer.
...
your hard drive and replace them with your new Openmandriva Lx GNU/Linux system, choose
...
Openmandriva Lx GNU/Linux operating system installation.

Click on \"%s\" if you wish to select partitions which will be checked for
bad blocks on the disk.", N("Next"), N("Previous"), N("Advanced"));
}
sub installUpdates() {
    N("By the time you install Openmandriva Lx GNU/Linux, it's likely that some packages will
...
to change it later with the draksec tool, which is part of Openmandriva Lx GNU/Linux
Control Center.
...
installation of your Openmandriva Lx GNU/Linux system. If partitions have already been
...
Openmandriva Lx GNU/Linux operating system.
...
upgrade of an existing Openmandriva Lx GNU/Linux system:
...
currently installed on your Openmandriva Lx GNU/Linux system. Your current partitioning
scheme and user data will not be altered. Most of the other configuration
steps remain available and are similar to a standard installation.

Using the ``Upgrade'' option should work fine on Openmandriva Lx GNU/Linux systems
running version \"8.1\" or later. Performing an upgrade on versions prior
to Openmandriva Lx GNU/Linux version \"8.1\" is not recommended.", N("Install"), N("Upgrade"));
}
sub selectKeyboard() {
...
still under development. For that reason, Openmandriva Lx GNU/Linux's use of UTF-8 will
...
operating systems may offer you one, but Openmandriva Lx GNU/Linux offers two. Each of
...
system you may change it by running PrinterDrake from the Openmandriva Lx GNU/Linux
...
Openmandriva Lx GNU/Linux Control Center after the installation has finished to benefit
...
Openmandriva Lx GNU/Linux Control Center.
...
Openmandriva Lx GNU/Linux partition. Be careful, all data on this drive will be lost
