...
sub remove_unused_packages {
    ...
    # Packages to not remove even if they seem unused
    my @wanted_hardware_packages = qw(gnome-bluetooth gnome-phone-manager kbluetooth kppp ppp wireless-tools wpa_supplicant networkmanager kernel-firmware-extra);
